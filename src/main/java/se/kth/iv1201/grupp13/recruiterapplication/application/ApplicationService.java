...
/**
 * <p>This is the application service class, which defines tasks that can be
...
public class ApplicationService {
	...
	public ApplicationDTO createApplication(User user, Date applicationDate) throws IllegalRecruiterTransactionException {
		ApprovalStatus status = approvalStatusRepo.findByName("UNHANDLED");
    ...
    /**
     * This is the method to find applications with specific time period the applicant can work.
     *
     * @param requiredFromDate The required date from which the applicant can begin to work.
     * @param requiredToDate The required date from which the applicant can end the work.
     * @return The applications that found by the searching time period the applicant can work.
     */
     ...
     * @return The applications that found by the searching specific application date.
     */
     ...
     * @return The applications that found by the searching specific user's name.
     */
