...
/**
 *   * The class takes in values for how long an applicant   * has worked within
...
public class CompetenceProfile implements CompetenceProfileDTO {
    ...
    /**
     * <p>
     * Creates a new instance with the specified user, competence,
     * yearsOfExperience. </p>
     *
     * <p>
     * A unique competence profile id will be set on the newly created
     * instance.</p>
     *
